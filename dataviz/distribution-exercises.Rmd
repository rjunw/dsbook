...
## Exercises (1-8 in distributions.Rmd)
...
```{r}
plot(pnorm(seq(min(x), max(x)), mean = mean(x), sd = sd(x)))
```
...
```{r}
(mean(between(x, 79, 81)))/(pnorm(81, mean = mean(x), sd = sd(x)) - pnorm(79, mean = mean(x), sd = sd(x)))
```
...
```{r}
(1 - pnorm(7*12, mean = 69, sd = 3)) * 1000000000
```
...
```{r}
10/((1 - pnorm(7*12, mean = 69, sd = 3)) * 1000000000)
```
...
```{r}
150/((1 - pnorm(6*12 + 8, mean = 69, sd = 3)) * 1000000000)
```
