...
For more on this more advanced topic we recommend the R packages book[^programming-basics-1].

[^programming-basics-1]: <http://r-pkgs.had.co.nz/namespace.html>
...
```{r}
identical(25*(25+1)*(2*25+1)/6, compute_s_n(25))
```
